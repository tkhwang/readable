...
export type UserFindAllQuery = { readonly __typename?: 'Query' } & {
  readonly userFindAll: ReadonlyArray<{ readonly __typename?: 'User' } & Pick<Types.User, 'id' | 'name'>>;
};
...
export type UserFindAllComponentProps = Omit<
  ApolloReactComponents.QueryComponentOptions<UserFindAllQuery, UserFindAllQueryVariables>,
  'query'
>;
...
export function useUserFindAllQuery(
  baseOptions?: Apollo.QueryHookOptions<UserFindAllQuery, UserFindAllQueryVariables>
) {
...
export function useUserFindAllLazyQuery(
  baseOptions?: Apollo.LazyQueryHookOptions<UserFindAllQuery, UserFindAllQueryVariables>
) {
  const options = { ...defaultOptions, ...baseOptions };
