...
export function ShadowCard(props: ShadowCardProps) {
  return (
    <div className="shadow-offset-black">
      {/* Header */}
      ...
      <div className="p-4 bg-red-400 opacity-90">
        <div className="flex flex-col sm:flex-row justify-between -mx-2 ">
          <div className="mx-2">
            ...
            <div className="text-white font-bold break-words min-w-48 overflow-hidden line-clamp-3">
      ...
      {/* Footer */}
      <div className="py-3 px-4 bg-red-400 flex justify-between items-center text-white text-xs">
        <div className="flex items-center">
